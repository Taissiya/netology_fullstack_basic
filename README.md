...
# [2 Неделя](https://github.com/netology-code/py-homeworks-basic/tree/cycle/1.python.console)
**Задача №1**
...
[# 3 Неделя](https://github.com/netology-code/py-homeworks-basic/tree/cycle/2.conditions)
**Задача 1**
...
[# 4 Неделя](https://github.com/netology-code/py-homeworks-basic/tree/master/3.introduce_datatypes)
**Задание 1**
...
```
[# 5 Неделя](https://github.com/netology-code/py-homeworks-basic/tree/master/3.introduce_datatypes)
**Задача №1**
...
[# 6 Неделя](https://github.com/netology-code/py-homeworks-basic/tree/master/5.functions)
